...
const Search = (props) => {
  ...
  return (
    <>
    <div className="bg-green-900 w-full flex flex-row">
      ...
      <div className="bg-green-900 p-4 text-white w-1/3">
      ...
      <div className="w-1/2">
        <button className="p-2 mt-6 w-60 rounded-md bg-green-500 text-white text-2xl transition duration-400 ease-in-out transform hover:-translate-y-0.5 hover:scale-102 hover:bg-gray-700">
          Nominations
        </button>
      </div>
    </div>
