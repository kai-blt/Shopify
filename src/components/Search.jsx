...
const Search = (props) => {
  ...
  return (
    <>
    {nominated.length >= 5 
      ?  <div className="absolute p-6 bg-yellow-300 w-full border-b-2 bg-opacity-75 animate-bounce rounded-md border-gray-500 text-2xl">Thanks for nominating your 5 favorite movies!</div>
      : null
    }
    <div className="bg-green-900 w-full flex xs:flex-col sm:flex-row md:flex-row lg:flex-row justify-between">
      <div className="px-4 py-2 w-72 h-32">
      ...
      <div className="bg-green-900 p-6 text-white w-2/3 lg:w-2/3">
        <div className="w-full border-5">
          <h1 className="text-lg">Search Movies</h1>
        </div>
         <div>
