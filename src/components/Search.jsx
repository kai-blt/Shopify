const Search = (props) => {
  return (
    <div class="bg-green-900 fixed w-full">
      <div class="w-48 px-4 py-2">
      ...
      <div class="rounded-md bg-green-900 p-4 text-white">
        <div class="w-full border-5">
          <h1  class=" text-3xl">Movie Search</h1>
        </div>
         <div>
          <form>
              <input
                type="text"
                name="search"
                class="rounded-sm px-2 py-1 text-gray-900"
              />
            </form>
        </div>
      </div>
